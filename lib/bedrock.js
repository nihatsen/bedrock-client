  ...
  for (const msg of messages) {
    ...
    if (msg.files && msg.files.length > 0) {
      for (const file of msg.files) {
        // FIX: Skip files whose base64 data was stripped to free localStorage.
        // When QuotaExceededError occurs, _stripFileData() in conversations.js
        // deletes file.data but keeps the file metadata. Without this guard,
        // Buffer.from(undefined, 'base64') throws:
